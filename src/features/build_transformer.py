...
def build_transformer() -> Pipeline:
	'''
	Build pipeline feature consisting of
	time_transformer
	device_transformer
	...
	logger.info(f"Build time_device_transformer: \n {pipeline}")

	return pipeline

def build_ctr_tranformer(params: FeatureParams) -> CtrTransformer:
	'''
	Build feature transformer for CTR computationo
	param:
